...
router.register('toimgs', ToImgViewSets)
router.register('categoryshows', CategoryShowViewSets)
router.register('youthers', YoutherviewSets)
router.register('shoetimes', ShoeTimeViewSets)
